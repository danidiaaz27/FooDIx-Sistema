// =============================================
// REGISTRO.JS - Sistema de Registro Multirol
// =============================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    typeButtons.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (currentUserType === 'cliente') {
                ...
                rolInput.value = '4';
            } else if (currentUserType === 'restaurante') {
    ...
    function validatePassword(password) {
        ...
        if (reqLength) {
            reqLength.className = minLength ? 'text-success' : 'text-danger';
            reqLength.textContent = (minLength ? '✓' : '✗') + ' Mínimo 8 caracteres';
        }
        if (reqUppercase) {
            reqUppercase.className = hasUppercase ? 'text-success' : 'text-danger';
            reqUppercase.textContent = (hasUppercase ? '✓' : '✗') + ' Una mayúscula';
        }
        if (reqLowercase) {
            reqLowercase.className = hasLowercase ? 'text-success' : 'text-danger';
