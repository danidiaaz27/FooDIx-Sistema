// =============================================
// REGISTRODELIVERY.JS - Sistema de Registro para Repartidores
// Maneja validación de datos personales (Paso 1) y datos del repartidor (Paso 2)
// =============================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // =============================================
    const pasoInicial = window.mostrarPasoInicial; // 'repartidor' o null
    ...
    // =============================================
    // BOTÓN SIGUIENTE - ENVÍA PASO 1 AL SERVIDOR
    // =============================================
    if (btnSiguiente) {
        btnSiguiente.addEventListener('click', function(e) {
            ...
            console.log('📝 [PASO 1] Rol seleccionado: Repartidor (3)');
            
            // Enviar formulario al servidor (POST /registro)
            // El servidor creará el usuario y redirigirá a /registro-repartidor para el paso 2
            registerForm.submit();
        });
    }
    
    // =============================================
    // BOTÓN VOLVER (del formulario de repartidor al personal)
    // =============================================
    ...
    // =============================================
    // VALIDACIÓN DE FORMULARIO DE REPARTIDOR
    // =============================================
    if (deliveryForm) {
